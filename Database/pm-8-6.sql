...
-- ----------------------------
INSERT INTO `pm_evaluation_records` VALUES ('2', '12', '11', '13', '4', '42', '47', '0', '1470455463');
INSERT INTO `pm_evaluation_records` VALUES ('3', '12', '12', '14', '4', '57', '17', '40', '1470455463');
...
CREATE TABLE `pm_work` (
  ...
  `e_time` int(11) unsigned NOT NULL DEFAULT '0',
  `f_time` int(11) unsigned NOT NULL DEFAULT '0',
  `status` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '0-正常未启动，1-已启动，2-已结束，3-已评价',
  `c_time` int(11) unsigned NOT NULL,
  PRIMARY KEY (`id`)
