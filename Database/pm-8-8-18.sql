...
--
-- Host: localhost
-- Generation Time: 2016-08-08 19:05:04
...
--
-- 转存表中的数据 `pm_evaluation_records`
--

INSERT INTO `pm_evaluation_records` (`id`, `leader_uid`, `member_uid`, `project_id`, `overall_accuracy_mark`, `sampling_inspection_mark`, `summary_mark`, `c_time`) VALUES
(2, 12, 11, 4, 42, 47, 0, 1470455463),
...
INSERT INTO `pm_summary` (`id`, `member_uid`, `project_id`, `content`, `c_time`) VALUES
(2, 12, 4, '码云是开源中国社区2013年推出的基于 Git 的完全免费的代码托管服务，这个服务是基于 Gitlab 开源软件所开发的，我们在 Gitlab 的基础上做了大量的改进和定制开发，目前已经成为国内最大的代码托管系统，致力于为国内开发者提供优质稳定的托管服务。码云主要功能码云除了提供最基础的 Git 代码托管之外，还提供代码在线查看、历史版本查看、Fork、Pull Request、打包下载任意版本、Issue、Wiki 、保护分支、代码质量检测、PaaS项目演示等方便管理、开发、协作、共享的功能。', 1470653785);
...
(4, 't1', 11, 2, 9, 2, 'taks1', 1438531200, 1475424000, 0, 0, 18, 1470106091),
...
--
-- Indexes for table `pm_summary`
--
ALTER TABLE `pm_summary`
 ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `pm_summary`
--
ALTER TABLE `pm_summary`
