...
-- ----------------------------
INSERT INTO `pm_project` VALUES ('2', 'project1', 'testtest1234', '2', '1467302400', '1468771200', '0', '0', '1469895728');
INSERT INTO `pm_project` VALUES ('3', 'project2', 'test2', '6', '1467734400', '1469462400', '0', '3', '1469895793');

-- ----------------------------
-- Table structure for `pm_project_work_records`
-- ----------------------------
DROP TABLE IF EXISTS `pm_project_work_records`;
CREATE TABLE `pm_project_work_records` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `project_id` int(11) unsigned NOT NULL,
  `work_id` int(11) unsigned NOT NULL,
  PRIMARY KEY (`id`)
...
-- ----------------------------
-- Records of pm_project_work_records
-- ----------------------------
