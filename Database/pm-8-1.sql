...
--
-- Host: localhost
-- Generation Time: 2016-08-01 16:34:13
...
(9, 'w3', 11, 2, 2, 'work3', 1468080000, 1468771200, 0, 0, 1470023432);
...
--
-- 表的结构 `pm_work_task_records`
--

CREATE TABLE IF NOT EXISTS `pm_work_task_records` (
`id` int(11) unsigned NOT NULL,
  `work_id` int(11) unsigned NOT NULL,
...
--
-- Indexes for table `pm_work_task_records`
--
ALTER TABLE `pm_work_task_records`
 ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `pm_work_task_records`
--
ALTER TABLE `pm_work_task_records`
MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT;
